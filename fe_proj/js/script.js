...
const questions = [
    {
        ...
        correctIndex: 1,
        explanation: "バイオメトリクス認証は、生体情報を利用して本人確認を行う技術だからである。\n他の選択肢は、A.鍵やカードのように紛失しない、C.声など行動的特徴も利用する、D.生体情報は簡単に変更できない、ため誤りである。"
    },
    {
    ...
    },
    {
        ...
        correctIndex: 2,
        explanation: "バイオメトリクス認証は本人固有の特徴を利用するため利便性が高い。\n他の選択肢は、A.誤認証が存在する、B:生体情報は一度漏洩すると変更できない、D:単独でも利用できる、ため誤りである。"
    }
];
